...
BG3 = pygame.transform.scale(pygame.image.load(os.path.join("Pygame", "Chicken_Invaders", "assets", "BG3.jpg")), (WIDTH, HEIGHT))
...
class Drop_box():
    ...
    def creat_box_new(self, color_picker):
...
def main():
    ...
    def redraw_window():
        ...
        if collide(box_bullet, player):
            ...
            box_bullet.creat_box_new(random.choice(["red", "green", "blue", "purple","orange"]))
        
        if rocket > 0: 
            rocket_enable = "Enable"
        else : 
            rocket_enable = "None"
        ...
        rocket_label = main_font.render(f": {rocket_enable}", rocket , (255,255,255))
